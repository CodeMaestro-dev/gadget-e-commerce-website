      ...
      >
        ...
        <Category text="Computers">
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_918_613">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>
        </Category>
        <Category text="SmartWatch">
          <svg
            width="56"
            height="56"
            viewBox="0 0 56 56"
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_918_629">
                <rect width="56" height="56" fill="white" />
              </clipPath>
            </defs>
          </svg>
        </Category>
        <Category text="Camera" active={true}>
          <svg
            width="56"
            height="56"
            viewBox="0 0 56 56"
